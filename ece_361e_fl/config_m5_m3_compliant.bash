...
# M3-compliant pruning-inspired batch.
#
# Important:
# - Every run in this file starts from scratch.
# - No init checkpoints or pre-trained weights are used.
# - The "pruning" idea here is expressed as smaller / slimmer architectures
#   that must learn from random initialization within the standard 30 rounds.
#
# Design:
# - Keep the proven winner families as anchors.
# - Compare them against the closest structured eco variants.
# - Stay focused on the non-IID, 1-local-epoch regime used in the competition.
...
# Team Black / balanced anchors and pruning-inspired Sword descendants
  "350 1 false champion_sword 0.010 fedprox 1.0 10.0 1 1"
  "351 1 false champion_sword 0.009 fedprox 1.0 10.0 1 1"
  "352 1 false vanguard_sword_eco 0.010 fedprox 1.0 10.0 1 1"
  "353 1 false vanguard_sword_eco 0.009 fedprox 1.0 10.0 1 1"

# Team Green anchors and pruning-inspired Explorer descendants
  "354 1 false champion_explorer_v2 0.010 fedavg 1.0 10.0 1 1"
  "355 1 false vanguard_explorerv2_eco 0.010 fedavg 1.0 10.0 1 1"
  "356 1 false champion_explorer_v2 0.010 fedmax 1.0 10.0 1 1"
  "357 1 false vanguard_explorerv2_depthwise_eco 0.010 fedmax 1.0 10.0 1 1"
)
